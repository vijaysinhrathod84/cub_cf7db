...
class Cub_Cf7db {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Cub_Cf7db_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-cub-cf7db-loader.php';
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-cub-cf7db-i18n.php';
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-cub-cf7db-admin.php';
		require_once plugin_dir_path( __DIR__ ) . 'public/class-cub-cf7db-public.php';

		$this->loader = new Cub_Cf7db_Loader();
	}
	...
	private function set_locale() {
		$plugin_i18n = new Cub_Cf7db_I18n();
	...
	private function define_public_hooks() {
		$plugin_public = new Cub_Cf7db_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Cub_Cf7db_Loader    Orchestrates the hooks of the plugin.
	 */
